...
<ul class="pager">
    <?php if (isset($this->previous)): ?>
        <li class="previous">
            ...
            <a style="color: #333D4E; text-decoration:none; outline:none;" rel="prev" href="<?php echo html_escape($this->url(array(), null, $getParams)); ?>">&larr; Anteriores</a>
        </li>
    <?php endif; ?>
    ...
    <?php if (isset($this->next)): ?>
        <li class="next">
            ...
            <a style="color: #333D4E; text-decoration:none; outline:none;" rel="next" href="<?php echo html_escape($this->url(array(), null, $getParams)); ?>">Próximos &rarr;</a>
        </li>
    <?php endif; ?>
</ul>
